                ...
                <div class="p-5 relative">
                    ...
                    <div class="mt-4 h-full">
                        ...
                        <div class="flex relative bottom-0 justify-end">
                            <button class="relative right-2 my-5 mx-1 text-xs font-semibold bg-blue-600 py-2 px-10 rounded-sm text-white flex" @click="creatRole()" :disabled="loading.role_upsert">
                                Create role
...
export default {
    ...
    methods: {
        ...mapActions(useGuardStore,['getPriviledges','upsertRole']),
        closeModel() {
            this.model.model_open = false;
            this.$emit('close','new_role_model');
        },
