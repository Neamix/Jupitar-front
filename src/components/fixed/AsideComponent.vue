        ...
        <div class="menus">
            <ul class="main">
                <ul class="team-menu menu  mt-3">
                    <h2 class=" font-semibold text-us text-gray-500 " v-if="collectionStore.menu">Team Managment</h2>
                    <li class="item py-2">
                        <router-link :to="{name: 'home'}">
                            <i class="fa-solid fa-gauge pr-2 dark:text-white"></i>
                            <span class="title" v-if="collectionStore.menu">Dashboard</span>
                        </router-link>
                    </li>
                    <li class="item py-2">
                        <router-link :to="{name: 'monitoring'}">
                            <i class="fa-solid fa-display pr-2 dark:text-white"></i>
                    ...
                    <li class="item py-2" v-if="hasPriviledges('colleges')">
                        <router-link :to="{name: 'colleges'}">
                            <font-awesome-icon icon="user" class="icon pr-2 dark:text-white"/>
                    ...
                    <li class="item py-2">
                        <router-link :to="{name: 'roles'}" @click="this.collectionStore.smallMenu = true">
                            <i class="fa-solid fa-dice-d20 pr-2 dark:text-white"></i>
                ...
                <ul class="system-menu menu">
                    <h2 class=" font-semibold text-us text-gray-500 mt-2" v-if="collectionStore.menu">User Managment</h2>
                    <li class="item py-2">
